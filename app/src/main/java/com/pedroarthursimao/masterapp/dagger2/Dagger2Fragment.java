package com.pedroarthursimao.masterapp.dagger2;
...
public class Dagger2Fragment extends Fragment {
    ...
    public static String TITLE = "Dagger 2";
    @Bind(R.id.toolbar)
    Toolbar toolbar;

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_dagger2, container, false);
